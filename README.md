...
argocd app get test-app06

# Ver los pods desplegados
kubectl get pods -n dev -l app=test-app06

# Ver los logs
kubectl logs -n dev -l app=test-app06 --tail=50
```
...
kubectl port-forward -n dev svc/test-app06 8080:80
