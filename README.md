...
argocd app get test-008app

# Ver los pods desplegados
kubectl get pods -n dev -l app=test-008app

# Ver los logs
kubectl logs -n dev -l app=test-008app --tail=50
```
...
kubectl port-forward -n dev svc/test-008app 8080:80
