...
argocd app get test-001001

# Ver los pods desplegados
kubectl get pods -n dev -l app=test-001001

# Ver los logs
kubectl logs -n dev -l app=test-001001 --tail=50
```
...
kubectl port-forward -n dev svc/test-001001 8080:80
