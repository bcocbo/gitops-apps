...
argocd app get testapp-custom

# Ver los pods desplegados
kubectl get pods -n dev -l app=testapp-custom

# Ver los logs
kubectl logs -n dev -l app=testapp-custom --tail=50
```
...
kubectl port-forward -n dev svc/testapp-custom 8080:80
