...
argocd app get test-app07

# Ver los pods desplegados
kubectl get pods -n dev -l app=test-app07

# Ver los logs
kubectl logs -n dev -l app=test-app07 --tail=50
```
...
kubectl port-forward -n dev svc/test-app07 8080:80
