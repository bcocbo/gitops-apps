...
argocd app get test-app04

# Ver los pods desplegados
kubectl get pods -n dev -l app=test-app04

# Ver los logs
kubectl logs -n dev -l app=test-app04 --tail=50
```
...
kubectl port-forward -n dev svc/test-app04 8080:80
