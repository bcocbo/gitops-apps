...
argocd app get test-prueba2

# Ver los pods desplegados
kubectl get pods -n dev -l app=test-prueba2

# Ver los logs
kubectl logs -n dev -l app=test-prueba2 --tail=50
```
...
kubectl port-forward -n dev svc/test-prueba2 8080:80
